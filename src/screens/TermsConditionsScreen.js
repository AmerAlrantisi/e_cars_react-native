  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.text}>
        ...
        These terms and conditions apply to the JO EV app (hereby referred to as "Application") for mobile devices that was created by (hereby referred to as "Service Provider") as a free service.
        ...
        {'\n\n'}<Text style={styles.subTitle}>Changes to These Terms and Conditions</Text>{'\n'}
        The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms and Conditions on this page.

        {'\n\n'}These terms and conditions are effective as of 2024-09-11

        {'\n\n'}<Text style={styles.subTitle}>Contact Us</Text>{'\n'}
        If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at 2024joev@gmail.com.
      </Text>
    </ScrollView>
  );
};
